            ...
            filteredLeads.map((lead, index) => (
              ...
              >
                <motion.div
                  ...
                  className="bg-slate-900/50 backdrop-blur-xl border border-white/5 rounded-2xl overflow-hidden group hover:border-emerald-500/30 transition-all hover:bg-slate-800/50"
                >
                  <div className="p-6">
